...
story = Story.create(subtitle: '世界でいちばんうつくしいひと', novel_id: 2, penname: 'いそっぷ', user_id: 3, comment: 'しらゆきひめ・・・強く生きて(;_;)', content: 'そのうちに、白雪姫しらゆきひめは、大きくなるにつれて、だんだんうつくしくなってきました。お姫さまが、ちょうど七つになられたときには、青々と晴れた日のように、うつくしくなって、女王さまよりも、ずっとうつくしくなりました。ある日、女王さまは、鏡の前にいって、おたずねになりました。
「鏡や、鏡、壁にかかっている鏡よ。
　国じゅうで、だれがいちばんうつくしいか、いっておくれ。」
　すると、鏡は答えていいました。
