...
class NovelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create novel" do
    assert_difference('Novel.count') do
      post novels_url, params: { novel: { created: @novel.created, novel_id: @novel.novel_id, title: @novel.title, updated: @novel.updated } }
    end
  ...
  test "should update novel" do
    patch novel_url(@novel), params: { novel: { created: @novel.created, novel_id: @novel.novel_id, title: @novel.title, updated: @novel.updated } }
